        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    ...
                    <div class="col-xs-4">
                      <a href="<?php echo base_url().'admin/assembled_bom_save_as_excel/'.$bom_details['bom_no']; ?>" class="btn btn-default btn-primary"><i class="fa fa-file-excel-o"></i> Save As Excel(Not working)</a>
